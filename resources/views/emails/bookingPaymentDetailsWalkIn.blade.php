                 ...
                 <tr>
                  <td align="center" class="es-m-p0r" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;border-top:2px solid #efefef;border-bottom:2px solid #efefef" role="presentation">
                     ...
                     <tr>
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#666666;font-size:14px">Please proceed to the front desk at AJ DIA Fitness Gym to make your payment.<br><br>Once payment is completed, you will receive a receipt. Kindly keep this receipt as proof of payment.<br><br>
                        For record purposes, please provide your Booking ID to the staff during payment. <br> <br>You may also send it as a private message to our Facebook Page: <strong style="color:#cc0000"><a href="https://www.facebook.com/AJDIAFITNESS" target="_blank" style="mso-line-height-rule:exactly;text-decoration:underline;color:#cc0000;font-size:14px">AJ DIA Fitness Gym</a></strong> make sure to indicate your Booking ID.</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px"><br></p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
