                                        ...
                                        <div class="col offset-md-4 ps-3 pe-2">
                                            <div class="row justify-content-center align-items-center g-2 py-1 ps-2 password-requirements"
                                                ...
                                                <div class="col-6 char-length"><i
                                                    ...
                                                    characters long</div>
                                                <div class="col-6 uppercase"><i class="bi bi-x-square-fill text-danger"></i>
                                                    One
                                                    Uppercase letter</div>
                                                <div class="col-6 lowercase"><i class="bi bi-x-square-fill text-danger"></i>
                                                    One
                                                    Lowercase letter</div>
                                                <div class="col-6 number"><i class="bi bi-x-square-fill text-danger"></i>
                                                    One
                                                    Number
                                                </div>
